...
function EmailToken() {
  ...
  const { newtoken, user_id } = useParams();
  ...
  const navigate = useNavigate()
    ...
    useEffect(() => {
        console.log('123');
        try{
          console.log("kikiikkkikiiikkiki")
          getRequest(`/user/foractivate-account/${user_id}/${newtoken}`).then(res => {
          console.log("then")
          ...
          console.log(token)
              ...
              // navigate('user/reset-password/:userid/:token')
                  // navigate('user/reset-password')
                  

                  navigate(`/reset-password/${user_id}/${token}`);
        ...
        {
          console.log("kookokokokokokokokoko")
