...
function PageResponse() {
  ...
  <div class="max-w-xl px-5 text-center">
    ...
    <h2 class="mb-2 text-[42px] font-bold text-zinc-800">Please Wait For Our Response</h2>

    <p class="mb-2 text-lg text-zinc-500">We are glad, that you’re with us ? We will sent you a verification link to the email address <span class="font-medium text-indigo-500">mail@yourdomain.com</span>.</p>
